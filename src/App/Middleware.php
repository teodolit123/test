...
class Middleware
{
    ...
    private static array $WEBmiddlewares = [
        'ItemController@create' => 'WEBauthentication',
        'ItemController@store' => 'WEBauthentication',
        'ItemController@edit' => 'WEBauthentication',
        'ItemController@update' => 'WEBauthentication',
        'ItemController@delete' => 'WEBauthentication',
    ...
    private static array $APImiddlewares = [
        'ItemController@store' => 'APIauthentication',
        'ItemController@update' => 'APIauthentication',
        'ItemController@delete' => 'APIauthentication',
